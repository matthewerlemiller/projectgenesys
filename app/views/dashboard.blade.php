            ...
            <div class="Card-content" ng-cloak>
                <a href="member/@{{ checkInLog.member.id }}" ng-repeat="checkInLog in checkInLogs">
                    <div class="result" ng-class="{ 'left-result' : $index % 3 === 0, 'right-result' : ($index + 1) % 3 === 0 }">
                        <div class="Flair Flair--orange Flair-top" ng-if="checkInLog.member.leadsJrStaff && checkInLog.member.status.id !== 2" ng-cloak>Jr Staff</div>
                        <div class="Flair Flair--red Flair-top" ng-if="checkInLog.member.status.id === 2">Kicked Out</div>
