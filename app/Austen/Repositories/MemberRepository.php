...
class MemberRepository {
    ...
    public function status($id) 
    {
        try {           
            ...
            $member = $member[0];       
            $badBehaviorEvents = $member->badBehaviorEvents()->where('created_at', '>=', Carbon::now()->subDay())->where('active', '=', true)->get();
    ...
    public function kickout() 
    {
        ...
        try {
            ...
            $badBehaviorEvent->shiftId = $shiftId;
            $badBehaviorEvent->comments = $comments;
            $badBehaviorEvent->locationId = $locationId;
            $badBehaviorEvent->leaderId = $leaderId;
